        ...
        <aside className="lg:col-span-2 space-y-6">
          <div className="rounded-2xl bg-linen/60 p-6 ring-1 ring-border">
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://instagram.com" aria-label="Instagram" className="grid h-10 w-10 place-items-center rounded-full bg-card ring-1 ring-border hover:bg-brass/10"><Instagram size={16} /></a>
